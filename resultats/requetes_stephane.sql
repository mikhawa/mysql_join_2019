...
ON perm.idperm = theuser.perm_idperm
LEFT JOIN article
ON article.idarticle = theuser.idtheuser;
...
ON perm.idperm = theuser.perm_idperm
INNER JOIN article
ON article.theuser_idtheuser = theuser.idtheuser;
...
SELECT article.idarticle, article.thetitle, article.thedate, theuser.idtheuser, theuser.thelogin,
GROUP_CONCAT(categ.idcateg)AS idcateg,
GROUP_CONCAT(categ.thetitle SEPARATOR "_o!o_")AS ctitle
FROM article
